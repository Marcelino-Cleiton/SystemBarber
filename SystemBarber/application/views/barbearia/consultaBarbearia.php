    ...
    <!--Recebe por ajax-->
		<div class="modal-header">
         ...
         <div class="modal-body">
            ...
            <form action="<?php echo base_url('Barbearia/Alterar')?>" method="POST">
            <select id="boxResultBarbearia" multiple="multiple" name="consultafantasia" style="height:200px;width:100%">
              
                   

            </select> 
            <input Class="btn" type="submit"  id="botaoconsult" name="botao"   value="Editar"/>
            </form>
         </div>
