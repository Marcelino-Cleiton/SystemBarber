      ...
      <div class="span12">
        <div class="widget">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Cadastro Usuario</h4>
                        <span class="tools">
          ...
          <div class="widget-body">
            <form action="<?php echo base_url('index.php/BarbeariaController/Alteracaobanco')?>" method="POST" class="form-horizontal">
                      <div class="control-group">
                          <label class="control-label">Nome:</label class="control-label">
                            <div class="controls">
                                ...
                                <a href="#ConsultaUsuario" role="button" class="btn" data-toggle="modal"><i class="icon-search"></i></a> 
                            </div>    
                      </div>         
                      <div class="control-group"> 
                      ...
                      <div class="control-group"> 
                        <label class="control-label">Barbearia: </label class="control-label">
                          <div class="controls">
                          <input type="text" min="6" id="fantasia" max="45" class="input-xlarge" placeholder="Barbearia"  required></input>
                          <input type="hidden" name="idbarbearia" id="idbarbearia" value="">
                      ...
                      <div class="control-group">
                        <label class="control-label">Cidade: </label class="control-label">
                          <div class="controls">
                            <input type="text" min="9" id="idcidade" max="14" class="input-xlarge" placeholder="Cidade" name="cidade"  required/>
                            <a href="#ConsultaCidade" role="button" class="btn" data-toggle="modal"><i class="icon-search"></i></a> 
                          </div> 
                      </div>
                      <div class="control-group">
                  ...
                  <div class="form-actions">
                    <input type="submit" Class="btn" name="botao"   value="Cadastrar"/>
                  </div>  
            </form>
          </div>        
        </div>              
